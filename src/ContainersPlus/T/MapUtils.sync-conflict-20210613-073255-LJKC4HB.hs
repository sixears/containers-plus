...
import Fluffy.Containers.NonEmptyHashSet
                        ( NonEmptyHashSet, fromList, singleton )
import Fluffy.MonadIO   ( Exited )
import Fluffy.MapUtils  ( MapDupKeyError( MapDupKeyError ), fromListDupsE
                        , fromListWithDups, invertMap, invertMapS, mapFromList
                        , mergeMaps
                        )
import Fluffy.Tasty     ( assertListEqS, assertListEqRS, runTestsP_ )
...
hunitGroup :: TestTree
hunitGroup =
  testGroup "Fluffy.MapUtils hunit" [ mapFromListTests
                                    , fromListWithDupsTests, fromListDupsETests
                                    , invertMapTests, invertMapSTests
                                    , mergeMapsTests
                                    ]
